...
import 'package:vokki/src/features/words/data/words_repository.dart';

class WordsGrid extends ConsumerWidget {
  const WordsGrid({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final wordsRepository = ref.watch(wordsRepositoryProvider);
    final words = wordsRepository.getWordsList();
    return Container();
  }
}

class WordsLayoutGrid extends StatelessWidget {
  const WordsLayoutGrid({
    super.key,
