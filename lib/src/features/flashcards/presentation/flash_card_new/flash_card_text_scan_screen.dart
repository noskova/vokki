...
class FlashCardTextScanScreen extends ConsumerStatefulWidget {
  const FlashCardTextScanScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _FlashCardTextScanScreenState();
}

class _FlashCardTextScanScreenState
    extends ConsumerState<FlashCardTextScanScreen> with WidgetsBindingObserver {
        ...
        return Stack(
          children: [
            ...
            Scaffold(
              appBar: AppBar(
                title: Text(
                  'Point the camera at the text'.hardcoded,
                ),
              ),
                        ...
                        Container(
                          ...
                          child: Center(
                            child: ElevatedButton(
                              ...
                              child: Text('Scan text'.hardcoded),
                            ),
                          ),
                        ),
                      ],
                  ...
                  : Center(
                      child: SizedBox(
                        child: Padding(
                          ...
                          child: Text(
                            'Camera permission denied'.hardcoded,
